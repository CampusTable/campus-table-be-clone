...
import shop.campustable.campustablebeclone.global.properties.SpringDocProperties;

@OpenAPIDefinition(
  info = @Info(
    title = "🍱 Campus Table 🍱",
    description = """
            ### 🌐 CampusTable 웹사이트 🌐 : https://www.campustable.shop
            [**웹사이트 바로가기**](https://www.campustable.shop)
            
            ### 💻 **GitHub 저장소**
            - **[백엔드 소스코드](https://github.com/CampusTable/campus-table-be)**
